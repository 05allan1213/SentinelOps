...
type fixture32SecretResolver struct{ value []byte }

func (r *fixture32SecretResolver) Resolve(context.Context, appconfig.SecretRef) ([]byte, error) {
...
func TestMCPSecretHeaderResolvesOnlyDuringRequest(t *testing.T) {
	...
	resolver := &fixture32SecretResolver{value: []byte("Bearer short-lived")}
...
type fixture32FakeSession struct {
	listErr error
	closeN  int
}

func (s *fixture32FakeSession) ListTools(context.Context, *mcp.ListToolsParams) (*mcp.ListToolsResult, error) {
	if s.listErr != nil {
...
func (*fixture32FakeSession) CallTool(context.Context, *mcp.CallToolParams) (*mcp.CallToolResult, error) {
	return &mcp.CallToolResult{}, nil
}

func TestMCPOpenToolsListFailureClosesImmediately(t *testing.T) {
	fake := &fixture32FakeSession{listErr: errors.New("list unavailable")}
	closed := false
...
func TestMCPBudgetToolReservesAndSettlesSharedHook(t *testing.T) {
	base := &fixture32Invokable{info: "search", result: "ok"}
	hook := &fixture32BudgetHook{}
...
type fixture32AddParams struct {
	X int `json:"x"`
	Y int `json:"y"`
}
...
func TestMCPOfficialSDKServerAndToolPolicy(t *testing.T) {
	...
	server := mcp.NewServer(&mcp.Implementation{Name: "phase32-server", Version: "v1"}, nil)
	mcp.AddTool(server, &mcp.Tool{Name: "add", Description: "sum values"}, func(context.Context, *mcp.CallToolRequest, fixture32AddParams) (*mcp.CallToolResult, any, error) {
	...
	client := mcp.NewClient(&mcp.Implementation{Name: "phase32-client", Version: "v1"}, nil)
...
type fixture32Invokable struct{ info, result string }

func (t *fixture32Invokable) Info(context.Context) (*schema.ToolInfo, error) {
	return &schema.ToolInfo{Name: t.info}, nil
}
func (t *fixture32Invokable) InvokableRun(context.Context, string, ...tool.Option) (string, error) {
	return t.result, nil
}

type fixture32BudgetHook struct {
	reserve, settle int
	last            BudgetSettlement
}

func (h *fixture32BudgetHook) ReserveMCP(context.Context, BudgetRequest) error {
	h.reserve++
	return nil
}
func (h *fixture32BudgetHook) SettleMCP(_ context.Context, s BudgetSettlement) error {
	h.settle++
	h.last = s
	return nil
}
