...
type fixture32MCPBudgetDouble struct {
	reserved []BudgetCall
	settled  []BudgetSettlement
}

func (*fixture32MCPBudgetDouble) RuntimeBudgetHandle() {}
func (d *fixture32MCPBudgetDouble) ReserveCall(_ context.Context, call BudgetCall) (BudgetReservation, error) {
	d.reserved = append(d.reserved, call)
	return BudgetReservation{Identity: call.ReservationIdentity}, nil
}
func (d *fixture32MCPBudgetDouble) SettleCall(_ context.Context, settlement BudgetSettlement) error {
	d.settled = append(d.settled, settlement)
	return nil
}

func TestMCPBudgetHookUsesSharedReservationDimensions(t *testing.T) {
	double := &fixture32MCPBudgetDouble{}
