...
export default function InvestigationMap({ logs, selected, onSelect }: Props) {
  ...
  return (
    <div className="w-[200px] border-r border-gray-200 bg-white p-3 flex flex-col">
      <div className="text-xs font-bold text-gray-900 mb-4">研判路径</div>
          ...
          return (
            ...
            >
              <div className={cn(
                ...
                status === 'completed' ? 'bg-[#3FB950]/20' : 'bg-white border border-gray-200'
              )}>
                {status === 'running' ? (
